...
const freeFeatures = [
  '1 profesional',
  'Link de reservas (IG/WhatsApp)',
  'Recordatorios email (límite)',
];
      ...
      <Container>
        ...
        <div className="relative hidden lg:block">
          <motion.div
            ...
            className="grid gap-5 lg:gap-6 grid-cols-2 xl:grid-cols-4 items-stretch"
          >
            {/* Plan Free */}
            <motion.div
              variants={fadeInUp}
            ...
            >
              <div className="mb-1 sm:mb-2 text-sm sm:text-sm font-semibold text-foreground">Free</div>
              <div className="mb-2 sm:mb-3 flex items-baseline justify-center gap-1">
                <span className="text-2xl sm:text-3xl font-semibold text-foreground">Gratis</span>
                <span className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400">para empezar</span>
              </div>
              <p className="mb-3 sm:mb-4 text-sm sm:text-xs text-neutral-700 dark:text-neutral-400">
                Perfecto para coger volumen con reservas online.
              </p>
              ...
              <div className="mt-auto">
                <Button as="link" href="/demo" variant="outline" className="w-full text-sm sm:text-sm">
                  Empezar gratis
                </Button>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="mt-auto">
                <Button as="link" href="/alta?plan=starter" variant="outline" className="w-full text-sm sm:text-sm">
                  Empezar con Starter
                </Button>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="relative flex flex-col rounded-2xl sm:rounded-3xl border border-border bg-card p-4 sm:p-5 lg:p-6 shadow-[0_18px_45px_rgba(15,23,42,0.06)] dark:border-neutral-800 dark:bg-neutral-900/70 dark:shadow-sm text-center"
            >
              <div className="mb-1 sm:mb-2 text-sm sm:text-sm font-semibold text-foreground">Scale</div>
              <div className="mb-2 sm:mb-3 flex items-baseline justify-center gap-1">
                <span className="text-2xl sm:text-3xl font-semibold text-foreground">199€</span>
                <span className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400">/mes</span>
              </div>
              <p className="mb-3 sm:mb-4 text-sm sm:text-xs text-neutral-700 dark:text-neutral-400">
          ...
          <div className="mt-6 flex items-center justify-center">
            <Button as="link" href="/contacto" variant="ghost" className="text-sm border border-border dark:border-neutral-800">
              ¿Necesitas Enterprise? Hablemos
            </Button>
          </div>
        </div>
