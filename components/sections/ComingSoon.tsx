...
const ComingSoon = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-orange-50 dark:from-neutral-950 dark:via-neutral-950 dark:to-neutral-900 flex items-center justify-center px-4">
      <div className="max-w-lg w-full text-center">
        ...
        <div className="mt-10 flex items-center justify-center">
          <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-orange-500 to-pink-500 shadow-lg shadow-orange-500/20 dark:shadow-none" />
        </div>
