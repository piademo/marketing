  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24">
      <Container>
        ...
        >
          <h2 className="text-3xl sm:text-display-sm lg:text-display-md mb-3 sm:mb-4 text-foreground text-balance">
            ¿Para quién es <span className="gradient-text">BookFast</span>?
          </h2>
          <p className="text-base sm:text-base lg:text-lg text-neutral-700 dark:text-neutral-300 px-2">
            ...
            <motion.div key={sector.href} variants={itemVariants}>
              <Card hover className="h-full p-4 sm:p-6">
                <CardHeader className="p-0 mb-4">
                  ...
                  <CardDescription className="text-sm sm:text-sm">{sector.description}</CardDescription>
                </CardHeader>
