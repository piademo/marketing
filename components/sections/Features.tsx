          ...
          <motion.div variants={fadeInUp} className="col-span-2">
            <GlassCard className="h-full flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 group p-4 sm:p-5" gradient="subtle">
              <div 
                ...
                className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-primary-500/20 flex items-center justify-center text-primary-400 shrink-0 group-hover:scale-110"
              >
          ...
          <motion.div variants={fadeInUp} className="col-span-2">
            <GlassCard className="h-full flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 group p-4 sm:p-5" gradient="strong">
              <div
                ...
                className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-green-500/20 flex items-center justify-center text-green-400 shrink-0 group-hover:scale-110"
              >
          ...
          <motion.div variants={fadeInUp} className="col-span-1">
            <GlassCard className="h-full group p-4 sm:p-5">
              <div
                ...
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-purple-500/20 flex items-center justify-center text-purple-400 mb-3 group-hover:scale-110"
              >
          ...
          <motion.div variants={fadeInUp} className="col-span-1">
            <GlassCard className="h-full group p-4 sm:p-5">
              <div
                ...
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-orange-500/20 flex items-center justify-center text-orange-400 mb-3 group-hover:scale-110"
              >
