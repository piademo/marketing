...
export default function Hero() {
  return (
    <section className="relative h-[100dvh] w-full flex flex-col justify-center overflow-hidden py-8 sm:py-12 lg:py-16 text-white">
      ...
      <Container>
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mb-4 sm:mb-6 lg:mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <h1 className="mb-4 sm:mb-6 max-w-4xl text-3xl sm:text-display-sm md:text-display-md lg:text-display-lg font-bold tracking-tight text-white animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100 text-balance">
          ...
          <p className="mb-6 sm:mb-8 lg:mb-10 max-w-2xl text-sm sm:text-base md:text-lg lg:text-xl text-neutral-300 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200 text-balance px-2">
          ...
          {/* CTAs */}
          <div className="mb-6 sm:mb-8 lg:mb-10 flex flex-col items-center justify-center gap-3 sm:gap-4 sm:flex-row">
          ...
          {/* Logos strip */}
          <div className="mt-6 sm:mt-8 w-full border-t border-white/5 pt-4 sm:pt-6">
