              ...
              <div className="mt-6 flex gap-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-lg bg-white text-neutral-600 hover:text-primary-600 transition-colors shadow-soft hover:shadow-medium"
